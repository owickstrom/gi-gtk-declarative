...
let
  ...
  generated = self: {
    ...
    "mkdocs-material" = python.mkDerivation {
      name = "mkdocs-material-3.1.0";
      src = pkgs.fetchurl { url = "https://files.pythonhosted.org/packages/10/6d/bc37ceee7979bcb5a9d82f5fb2a487c862853cfc3b7d1f3f70bcf47e11a4/mkdocs-material-3.1.0.tar.gz"; sha256 = "52522c8553a6d6da8fca2afe43297e8f88acdcf8ccf752a118148f1328f761e2"; };
      doCheck = commonDoCheck;
      buildInputs = commonBuildInputs;
      propagatedBuildInputs = [
      self."Pygments"
